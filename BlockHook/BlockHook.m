...
{
    struct BHInvocatonStruct *inv = (__bridge struct BHInvocatonStruct *)(self.invocation);
    [self.token invokeOriginalBlockWithArgs:inv->frame retValue:inv->retdata];
}
...
static void BHFFIClosureFunc(ffi_cif *cif, void *ret, void **args, void *userdata)
{
    ...
    *(void **)userRet = NULL;
    ...
    invocation.invocation = [NSInvocation invocationWithMethodSignature:token.originalBlockSignature];
    struct BHInvocatonStruct *inv = (__bridge struct BHInvocatonStruct *)(invocation.invocation);
    inv->frame = userArgs;
    inv->retdata = userRet;
